...
public class AdapterListArtikelOneCol extends RecyclerView.Adapter<AdapterListArtikelOneCol.TrendArtikelView> {

    private Context mContext;
    int rowLayout;
    private List<UserModel> trendArtikelModel;

    public AdapterListArtikelOneCol(Context mContext, int rowLayout, List<UserModel> trendArtikelModel) {
    ...
    @NonNull
    @Override
    public AdapterListArtikelOneCol.TrendArtikelView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    class TrendArtikelView extends RecyclerView.ViewHolder
    {
        ...
        public TrendArtikelView(@NonNull View itemView) {
            ...
            fotoArtikel = itemView.findViewById(R.id.recycler_foto_artikel_one_col);
            judulArtikel = itemView.findViewById(R.id.recycler_judul_artikel_one_col);
            namaPenulis = itemView.findViewById(R.id.recycler_penulis_artikel_one_col);
        }
    }
}
